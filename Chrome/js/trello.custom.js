...
(function () {
	var opts = {
		...
		"key": "44dade53f18a2871a94013b73291ba73"
	};
	...
	wrapper = function (c, g, b) {
		...
		f = {
			...
			rest: function () {
				...
				g.support.cors || (b.dataType = "jsonp", "GET" !== c && (b.type = "GET", g.extend(b.data, {
					_method: c
				})));
				m && (b.data.key = m);
				e && (b.data.token = e);
			...
			authorize: function (a) {
				...
				case "chromeTab":
					chrome.tabs.create({
						url:w({
							redirect_uri: b.redirect_uri || n.href,
		...
		u = function (a) {
			return f[a.toLowerCase()] = function () {
